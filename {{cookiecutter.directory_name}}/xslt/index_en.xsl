                        ...
                        <div class="row intro">
                            <div class="col-md-6 col-lg-6 col-sm-12 wp-intro_left">
                                <div class="intro_left">
                                    ...
                                    <a href="toc.html" title="Edition without Facsimiles">
                                        <button class="btn btn-secondary" role="button" style="width: 250px;">
                                            Edition without facsimiles
                                        </button>
                                    </a>
                                    <a href="toc_facs.html" title="Edition with Facsimiles">
                                        <button class="btn btn-secondary" role="button" style="width: 250px;">
                                            Edition with facsimiles
                                        </button>
                                    </a>
                                </div>
                            </div>
                                ...
                                <a href="toc.html" class="index-link">                                   
                                    <div class="card index-card">
                                        ...
                                        <div class="card-header">                                            
                                            <p>
                                                Template for an Edition without Facsimiles
                                            </p>                                            
                                        </div>
                                    </div>                                     
                                </a>                                    
                            ...
                            <div class="col-md-6 col-lg-6 col-sm-12">
                                <a href="toc_facs.html" class="index-link">                                                     
                                    <div class="card index-card">
                                        ...
                                        <div class="card-header">                                            
                                            <p>
                                                Template for an Edition with Facsimiles
                                            </p>                                            
                                        </div>
                                    </div>                                 
                                </a>
